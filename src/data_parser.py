...
def main():
    ...
    ipl_df = parse_all_matches('/Users/mandar/Library/Mobile Documents/com~apple~CloudDocs/NEU/NEU Content/Cricket Project/DOT_Pressure_Analysis/data/raw/ipl','IPL')
    t20i_df = parse_all_matches('/Users/mandar/Library/Mobile Documents/com~apple~CloudDocs/NEU/NEU Content/Cricket Project/DOT_Pressure_Analysis/data/raw/t20i','International Games')
    bbl_df = parse_all_matches('/Users/mandar/Library/Mobile Documents/com~apple~CloudDocs/NEU/NEU Content/Cricket Project/DOT_Pressure_Analysis/data/raw/bbl','BBL')

    print ("Combining all competitions...")
    all_data = pd.concat([ipl_df,t20i_df,bbl_df], ignore_index=True)

    output_path = '/Users/mandar/Library/Mobile Documents/com~apple~CloudDocs/NEU/NEU Content/Cricket Project/DOT_Pressure_Analysis/DOR_Pressure_Analysis/data/processed/raw_ballbyball_data.csv'
